...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    private String vehaddress,vehlat,vehlon;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ImageView cleartext = (ImageView)findViewById(R.id.clear);
        ...
        confirmlocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(MapsActivity.this, "Please locate the address", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    vehaddress = mSearchText.getText().toString();
                    vehlat = String.valueOf(marker.getPosition().latitude);
                    vehlon = String.valueOf(marker.getPosition().longitude);
